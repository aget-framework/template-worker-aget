...
# my-AGET-aget, my-example-aget, my-GITHUB-aget
...
**Actions**:
1. Go to https://github.com/aget-framework/aget/releases
...
```bash
cd /tmp
git clone https://github.com/aget-framework/aget.git test-v21
cd test-v21
