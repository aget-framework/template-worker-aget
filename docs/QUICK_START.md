...
curl -sSL https://raw.githubusercontent.com/aget-framework/aget/main/install.sh | bash -s . standard

# Or install in a specific directory
curl -sSL https://raw.githubusercontent.com/aget-framework/aget/main/install.sh | bash -s ~/myproject standard
```
...
git clone https://github.com/aget-framework/aget
