...
curl -sSL https://raw.githubusercontent.com/gabormelli/cli-agent-template/main/install.sh | bash -s . standard

# Or install in a specific directory
curl -sSL https://raw.githubusercontent.com/gabormelli/cli-agent-template/main/install.sh | bash -s ~/myproject standard
```
...
```bash
# Using wget instead
wget -qO- https://raw.githubusercontent.com/gabormelli/cli-agent-template/main/install.sh | bash
...
5. **Get help** → [GitHub Issues](https://github.com/gabormelli/cli-agent-template/issues)
...
**Need help?** Open an issue on [GitHub](https://github.com/gabormelli/cli-agent-template/issues) or check our [comprehensive docs](../README.md).
