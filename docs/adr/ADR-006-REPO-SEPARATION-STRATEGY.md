...
The question arose about AGET's vision for repository structure, specifically whether projects should use multiple repositories (EXAMPLE, EXAMPLE-data, EXAMPLE-context, EXAMPLE-workspace) by default.
