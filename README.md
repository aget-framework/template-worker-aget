...
```bash
curl -sSL https://raw.githubusercontent.com/gabormelli/aget-cli-agent-template/main/install.sh | bash -s . minimal
```
...
```bash
curl -sSL https://raw.githubusercontent.com/gabormelli/aget-cli-agent-template/main/install.sh | bash -s . advanced
```
