...
setup(
    ...
    url='https://github.com/aget-framework/aget-cli-agent-template',
    project_urls={
        'Bug Reports': 'https://github.com/aget-framework/aget-cli-agent-template/issues',
        'Source': 'https://github.com/aget-framework/aget-cli-agent-template',
    },
