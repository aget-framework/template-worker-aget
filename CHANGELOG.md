...
- Reference to academic [CLI Agent Template Framework](https://www.aget-framework.com/RKB/CLI_Agent_Template_Framework) concept
...
- Gabor Melli ([@aget-framework](https://github.com/aget-framework)) - Creator and maintainer
